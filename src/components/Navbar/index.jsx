...
const Navbar = () => {
  ...
  return (
    <>
      <div className="flex items-center justify-between p-6 h-[80px] bg-white shadow-md">
        ...
        <div className="flex justify-center gap-8 w-[463px]">
          <Link to="/" className="text-gray-700 font-semibold hover:text-[#46A358]">
            Home
          </Link>
          <Link to="/blog" className="text-gray-700 font-semibold hover:text-[#46A358]">
            Blog
          </Link>
        </div>
        ...
        <div className="flex gap-6 items-center">
          <span
            role="img"
            aria-label="search"
            className="text-gray-600 text-xl cursor-pointer hover:text-[#46A358]"
          >
            <svg
          ...
          <span
            className="text-gray-600 text-2xl cursor-pointer hover:text-[#46A358]"
          >
            <svg
              viewBox="64 64 896 896"
              focusable="false"
          ...
          <Link to="#">
            ...
            <button
              ...
              className="bg-[#46A358] flex items-center justify-center gap-2 text-white font-medium rounded-md w-24 h-9 hover:bg-[#398b47] transition"
            >
              <span
                role="img"
                aria-label="login"
      ...
      <hr className="border-[#46A358] my-4 mx-auto" />
    </>
  );
};
